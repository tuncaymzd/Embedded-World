...
namespace FailistSimulation
{
    public partial class Form1 : Form
    {
        ...
        [DllImport("libfaillist.so", EntryPoint = "error_report", CallingConvention = CallingConvention.Cdecl)]
        static extern void error_report([MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStr, SizeParamIndex = 7)]string[] message);

        [DllImport("/home/damien/Desktop/test/printing.so", EntryPoint = "writeToFile", CallingConvention = CallingConvention.Cdecl)]
        static extern void writeToFile([MarshalAs(UnmanagedType.LPStr)]string message);
